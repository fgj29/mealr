...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CYzye9XG.mjs");
...
var manifest = {
	"4b84af156646d42a97db010706f818b402c0f826d833884208aff2f716855265": {
		functionName: "loadKitchen_createServerFn_handler",
		importer: () => import("./kitchen-api-DJZK7Xfx.mjs")
	},
	"78b5c75798d520d1cd7e4ed08c792c8fc3ce7e6e8e4208e6f546a2a72a331cdd": {
		functionName: "joinKitchen_createServerFn_handler",
		importer: () => import("./kitchen-api-DJZK7Xfx.mjs")
	},
	"90f848e1b6ba161cac119d0c68a2f86b4bbf85a512211f1a0c80e1a374847292": {
		functionName: "saveKitchen_createServerFn_handler",
		importer: () => import("./kitchen-api-DJZK7Xfx.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-QRWWhZ4W.mjs").then((n) => n.t),
